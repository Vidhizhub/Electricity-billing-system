...
public class login extends JFrame implements ActionListener{
    ...
    login()
    {
        ...
        ImageIcon ic1=new ImageIcon(ClassLoader.getSystemResource("connection/images/login.jpg"));
        Image i1=ic1.getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT);
        b1=new JButton("Login",new ImageIcon(i1));

        ImageIcon ic2=new ImageIcon(ClassLoader.getSystemResource("connection/images/cancel.png"));
        ...
        ImageIcon ic3=new ImageIcon(ClassLoader.getSystemResource("connection/images/pop.jpg"));
